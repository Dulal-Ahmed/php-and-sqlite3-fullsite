    ...
    <div class="container">
        ...
        <div class="row" onclick="detectevent()" >
            <div class="col-lg-8 col-md-8 col-sm-12">
               ...
               <div class="top" >
                        <div>
                            <input type="checkbox" id="check" onclick="checkunchek()">&nbsp;
                            <label for="check">Tout sélectionner</label>
                        </div>
                        <div style="display: flex; align-items: center;" onclick="addBoxes()">
                            <!--  Add button  -->
                            <button type="button" class="btn add-btn addBox" onclick="clickshowform()"><img src="images/add.png" alt="">&nbsp;&nbsp;&nbsp;<input type="submit" name="save" value="Ajouter un produit" style="outline: none; border: none; background: transparent; color: white;"></button>&nbsp;
                    ...
                    <div id="clickopen"  class="box" style="display:none;" >
                        ...
                        <div class="image" style="margin-top:20px; flex:20%; ">
                          
                            <div class="img-box imageparentDiv">
                            <p  style="width:80px; height:80px; position:absolute; "><input type="file"  accept="image/*" name="image" id="file"  onchange="loadFile123(event)" style="display: none;"></p>
                              <label  style=" cursor: pointer; width:80px; height:80px; position:absolute; " for="file" style="cursor: pointer; width:100%; height:100%;  " >
                           <p style="width:80px; height:80px; position:absolute; display:flex;align-items:center;justify-content:center; "><img src="./images/image.png" id="output" style="width:40%;opacity:50%;" /></p></label>   
                
                        </div>
                        </div>
                        <div class="description" style=" flex:80%;" >
                            <div class="d-1">
                                <div>
                                    <!--  Prodduct link  -->
                                   <input type="text" name="productlink" placeholder="Product Link" style="border:1px solid gray; border-radius: 20px; padding:4px 16px; font-weight: 600; font-size:14px" required>
                                </div>
                                <div>
                                    <!-- <a href="">Edit</a> -->
                                </div>
                            ...
                            <h5><input type="text" name="productname" placeholder=" Product Name" style="border:1px solid gray; margin-top: 10px; border-radius: 20px; padding:2px 8px; font-weight: 500; font-weight: 600; font-size:18px;" required></h5>

                            <div class="points"  >
                                <div >
                                    <p class="pp-1">Quantité <br><input type="number" name="quantite" placeholder="-" style="border:1px solid gray; width: 100px; border-radius: 20px; padding:2px 8px;" required></p>
                                </div>
                                <div >
                                    <p class="pp-1">Prix <br> <input type="number" name="price" placeholder="-" style="border:1px solid gray; width: 100px; border-radius: 20px; padding:2px 8px;"></p>
                                </div>
                                <div >
                                    <p class="pp-1">Size <br><input type="text" name="size" placeholder="-" style="border:1px solid gray; width: 100px; border-radius: 20px; padding:2px 8px;"></p>
                                </div>
                                <div >
                                    <p class="pp-1">Color <br> <input type="text" name="color" placeholder="-" style="border:1px solid gray; width: 100px; border-radius: 20px; padding:2px 8px;"></p>
                                </div>
                            </div>
                        </div>
                    </div>            
